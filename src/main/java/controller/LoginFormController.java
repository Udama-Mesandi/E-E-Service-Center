...
public class LoginFormController {
    ...
    private void saveAdmin() throws SQLException, ClassNotFoundException {
        ...
        if(!isSaved){
            ...
            dto.setName("Udama");
            dto.setContact("0704122616");
            dto.setEmail("wumpeiris@gmail.com");
            dto.setPassword("5678@");
            dto.setPosition("Admin");
            dto.setDescription("Hi I'm Udama .I'm the System administrator of E and E Shop. I am highly experience in this industry. ");
            employeeBo.save(dto);
        }
    }
    ...
    private void sendEmail(String email) {
        ...
        String senderEmail = "udamamesandi2002@gmail.com";
        String senderPassword = "zpdc efuy awka cigy ";
